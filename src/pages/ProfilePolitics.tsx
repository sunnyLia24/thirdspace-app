...
const ProfilePolitics = () => {
  const navigate = useNavigate();
  const [selectedOption, setSelectedOption] = useState("Prefer not to say");

  const handleSave = () => {
    toast({
      title: "Profile updated",
      description: "Your political views have been saved.",
    });
    navigate('/profile');
  };
  ...
  return (
    <div className="pb-20 min-h-screen bg-[#f0f3f9]">
      <div className="bg-white shadow-md p-4 flex items-center justify-between sticky top-0 z-10">
        ...
        <h1 className="text-xl font-bold text-gray-800">Politics</h1>
        <Button 
          variant="ghost" 
          className="text-purple-800 font-medium p-2 hover:bg-purple-50 hover:text-purple-900 flex items-center"
          onClick={handleSave}
      ...
      <div className="p-6">
        <div className="bg-white rounded-xl shadow-md p-6">
          <p className="text-gray-500 mb-6">What are your political views?</p>
