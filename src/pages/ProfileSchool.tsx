...
const ProfileSchool = () => {
  ...
  const [schoolValue, setSchoolValue] = useState("Boston University");
  ...
  return (
    <div className="pb-20 min-h-screen bg-[#f0f3f9]">
      <div className="bg-white shadow-md p-4 flex items-center justify-between sticky top-0 z-10">
        ...
        <h1 className="text-xl font-bold text-gray-800">School</h1>
        <Button 
          variant="ghost" 
          className="text-purple-800 font-medium p-2 hover:bg-purple-50 hover:text-purple-900 flex items-center"
          onClick={handleSave}
      ...
      <div className="p-6">
        <div className="bg-white rounded-xl shadow-md p-6">
          <div className="space-y-4">
            <div>
              <Label htmlFor="school" className="text-gray-500 block mb-2">Where did you go to school?</Label>
              <Input
                id="school"
